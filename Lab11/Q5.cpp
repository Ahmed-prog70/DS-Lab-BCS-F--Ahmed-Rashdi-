...
int main()
{
    ...
    students.insert(101, "Ahmed");
    students.insert(102, "Neeraj");
    students.insert(102, "Usman");
    students.insert(302, "Fadil");
    students.insert(878, "Khizer");
    students.insert(767, "Zain");
